...
public class OrganizationGroupUserQueryTest extends AbstractOrganizationTest {
    ...
    public void testUserGetGroupsDoesNotIncludeOrgGroups() {
        ...
        String realmGroupIdForCleanup = realmGroupId;
        realm.cleanup().add(r -> r.groups().group(realmGroupIdForCleanup).remove());
    ...
    public void testGroupsCountDoesNotIncludeOrgGroups() {
        ...
        String realmGroup1IdForCleanup = realmGroup1Id;
        realm.cleanup().add(r -> r.groups().group(realmGroup1IdForCleanup).remove());
        ...
        String realmGroup2IdForCleanup = realmGroup2Id;
        realm.cleanup().add(r -> r.groups().group(realmGroup2IdForCleanup).remove());
