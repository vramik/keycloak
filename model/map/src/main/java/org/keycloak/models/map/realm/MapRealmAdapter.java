...
public class MapRealmAdapter extends AbstractRealmModel<MapRealmEntity> implements RealmModel {
    ...
    public int getActionTokenGeneratedByUserLifespan() {
        return entity.getActionTokenGeneratedByUserLifespan();
    }

    @Override
    public void setActionTokenGeneratedByUserLifespan(int seconds) {
        entity.setActionTokenGeneratedByUserLifespan(seconds);
    }
    ...
    public Map<String, Integer> getUserActionTokenLifespans() {
        Map<String, Integer> tokenLifespans = entity.getAttributes().entrySet().stream()
                ...
                .collect(Collectors.toMap(
                        entry -> entry.getKey().replace(ACTION_TOKEN_GENERATED_BY_USER_LIFESPAN, ""),
                        entry -> Integer.valueOf(entry.getValue())));

        tokenLifespans.put("", getActionTokenGeneratedByUserLifespan());
    ...
    public AuthenticationExecutionModel getAuthenticationExecutionByFlowId(String flowId) {
        MapAuthenticationExecutionEntity executionEntity = entity.getAuthenticationExecutions()
