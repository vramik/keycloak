...
/**
 * Changes {@code NCHAR(x)} type to {@code CHAR(x) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci} for MySQL database.
 * 
 * https://dev.mysql.com/doc/refman/8.0/en/charset-national.html
 * 
 */
public class MySQLNCharType extends NCharType {
...
//            }
            ...
            String newType = databaseDataType.getType().replace("NCHAR", "CHAR"); //TODO assuming uppercase
